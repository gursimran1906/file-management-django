...
from .views import edit_holiday_record, delete_holiday_record, add_document, delete_document, access_document, add_office_closure, holiday_record_csv, attendance_record_csv, sickness_record_csv
