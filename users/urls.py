...
from .views import edit_holiday_record, delete_holiday_record, add_document, delete_document, access_document, staff_document_download, add_office_closure, holiday_record_csv, attendance_record_csv, sickness_record_csv
from .views import download_all_employee_reports, holidays_summary_api, missing_days_api
...
urlpatterns = [
    ...
    path('staff-documents/<uuid:uuid>/download/', staff_document_download, name='staff_document_download'),
    ...
    path('holiday/delete/<int:holiday_id>/', delete_holiday_record, name='delete_holiday_record'),
    ...
    path('holidays-summary/', holidays_summary_api, name='holidays_summary_api'),
    path('missing-days/', missing_days_api, name='missing_days_api'),
