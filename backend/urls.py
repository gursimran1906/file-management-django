...
from .views import update_comment, export_user_tasks_pdf, load_management_tasks, download_user_risk_assessments_due, get_risk_assessments_due_data, add_matter_file_review, edit_matter_file_review
...
urlpatterns = [
    ...
    path('matter_file_review/edit/<int:id>/',
    ...
    path('<str:file_number>/attendance_notes/bulk_download/',
         download_attendance_notes_bulk, name='download_attendance_notes_bulk'),
    ...
    path('<str:file_number>/credit_note/add/',
         add_credit_note, name='add_credit_note'),
    path('credit_note/approve/<int:id>/',
         approve_credit_note, name='approve_credit_note'),
    path('credit_note/reject/<int:id>/',
         reject_credit_note, name='reject_credit_note'),
    path('credit_note/edit/<int:id>/',
         edit_credit_note, name='edit_credit_note'),
    ...
    path('api/risk-assessments-due/', get_risk_assessments_due_data,
         name='get_risk_assessments_due_data'),
